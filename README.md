...
# Optimization (in DGIST)

scripts 폴더 내의 run_eval.sh 쉘 스크립트 작동
(기존 원본 모델은 evaluation 코드, 경량화 모델은 경량화 기술이 추가된 evaluation16 코드로 평가 코드 적용) 

open_flamingo/mscoco_karpathy/train2014
open_flamingo/mscoco_karpathy/val2014
폴더는 n만 개의 이미지 파일의 용량 문제로 깃허브에 업로드가 되지 않아,

http://images.cocodataset.org/zips/train2014.zip
http://images.cocodataset.org/zips/val2014.zip
위 링크를 통해 다운로드 부탁드립니다.
